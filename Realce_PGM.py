...
def resize_and_save(input_arquivo, output_arquivo):
    ...
    histograma(new_pixels)

def histograma(new_pixels):
    dados = np.array(new_pixels, dtype=int)
...
arquivo_entrada = 'c:/Users/jukal/Desktop/HistogramaPDI/EntradaEscalaCinza.pgm'
resize_and_save(arquivo_entrada, 'c:/Users/jukal/Desktop/HistogramaPDI/Realce_ImagemPGM.pgm')
